...
// app/page.js
import SimultaneousNameAnimation from "@/components/SplittingNameAnimation";

export default function HomePage() {
  return (
    <main>
      <SimultaneousNameAnimation />
    </main>
  );
}
...
//   if (isLoading) {
//     // Helper to render split letters
//     const renderSplitName = (name: string) =>
//       name.split("").map((char, i) =>
//         char === " " ? (
//           <span key={i} style={{ width: "0.5ch" }} />
//         ) : (
//           <span className="split-letter" key={i}>
//             <span
//               className="split-letter-half top"
//               style={{ animationDelay: `${0.1 * i + 0.2}s` }}
//             >
//               {char}
//             </span>
//             <span
//               className="split-letter-half bottom"
...
//         <div
//           className="text-6xl font-bold name-animation"
//           style={{ gap: "0.1em" }}
//         >
//           {renderSplitName("Tanish Pradhan Wong Ah Sui")}
//         </div>
//       </div>
//     );
//   }
